<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Parallex.aspx.vb" Inherits="Test" %>
...
<html>
	...
	<head>
		...
		<link rel="stylesheet" media="all" href="CSS/ParallexScroll.css" />
	...
	<body>
		...
		<div id="wrapper">
			...
			<!-- Parallax foreground -->
			<div id="parallax-bg3">
				<img id="bg3-1" src="Images/Parallex/balloon.png" width="529" height="757" alt="Montgolfier hot air balloon"/>
				<img id="bg3-2" src="Images/Parallex/balloon2.png" width="603" height="583" alt="Frameless parachute"/>
				<img id="bg3-3" src="Images/Parallex/balloon3.png" width="446" height="713" alt="Blanchard's air balloon"/>
				<img id="bg3-4" src="Images/Parallex/ground.png" width="1104" height="684" alt="Landscape with trees and cows"/>
			</div>
			
			<!-- Parallax  midground clouds -->
			<div id="parallax-bg2">
				<img id="bg2-1" src="Images/Parallex/cloud-lg1.png" alt="cloud"/>
				<img id="bg2-2" src="Images/Parallex/cloud-lg1.png" alt="cloud"/>
				<img id="bg2-3" src="Images/Parallex/cloud-lg1.png" alt="cloud"/>
				<img id="bg2-4" src="Images/Parallex/cloud-lg1.png" alt="cloud"/>
				<img id="bg2-5" src="Images/Parallex/cloud-lg1.png" alt="cloud"/>
			</div>
			
			<!-- Parallax  background clouds -->
			<div id="parallax-bg1">
				<img id="bg1-1" src="Images/Parallex/cloud-lg2.png" alt="cloud"/>
				<img id="bg1-2" src="Images/Parallex/cloud-lg2.png" alt="cloud"/>
				<img id="bg1-3" src="Images/Parallex/cloud-lg2.png" alt="cloud"/>
				<img id="bg1-4" src="Images/Parallex/cloud-lg2.png" alt="cloud"/>
			</div>
